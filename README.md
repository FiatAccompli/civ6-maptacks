...
### Installation
  * STEAM_LINK (MOD_SETTINGS_MANAGER_LINK is also required.)
  * LOCAL_DOWNLOAD_LINK
...
* Keybinding for adding/editing a map tack (ctrl+D by default).
...
progress or disable it without breaking your game.  In general it should overrides 
map pin features in other UI mods, but if as with any civ 6 mods, if multiple active mods 
